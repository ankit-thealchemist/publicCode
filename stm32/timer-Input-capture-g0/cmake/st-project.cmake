...
# BASED ON /home/ankit/STM32CubeIDE/workspace_1.10.1/timer-g0
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mcpu=cortex-m0plus>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32G071RBTX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32G071RBTX_FLASH.ld>"
)

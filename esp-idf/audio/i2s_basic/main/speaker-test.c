...
void app_main(void)
{
    ...
    /**
     * @brief i2s module configuration
     *
     */
    i2s_config_t i2s_config = {
        .mode = I2S_MODE_MASTER | I2S_MODE_TX,  // for speaker its trasnfer and we are working in the master mode
        .sample_rate = SAMPLE_RATE,         // sample rate in Hz
        .bits_per_sample = I2S_BITS_PER_SAMPLE_16BIT,   // number of bits per sample
        .channel_format = I2S_CHANNEL_FMT_RIGHT_LEFT,   // compatible with dual channel, but tested on mono channel
